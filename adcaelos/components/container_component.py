...
class Container_Component(Base_Component):
    def __init__(self, Logic_Component: Logic_Component, Truth_Component: Truth_Component, Time_Varying_Components: list[Time_Varying_Component]=[], operationalStatus=Scheduler_Enums.ACTIVE, Component_Enum=Component_Enums.CONTAINER_COMPONENT, name: str = "Container_Component", UUID: int = None) -> None:
