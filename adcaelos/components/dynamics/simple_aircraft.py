...
class Simple_Aircraft(Truth_Component):
    ...
    def __init__(self, stateNames: list, 
                initial_state: np.array = np.zeros(20),
                initial_control: np.array = np.zeros(4),
                ...
                name: str = "Simple_Aircraft",
                UUID: int = None) -> None:
        super().__init__(stateNames,
                        initial_state,
                        initial_control,
                        integrator_type,
                        frequency,
